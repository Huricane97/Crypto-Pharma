    ...
    const handleSubmit = async (event) => {
        ...
        try {
            if (window.ethereum) {
                ...
                const result = await contract.methods.placeOrder(role, email, name, medicalId, productId).send({ from: accounts[0] });
                                    ...
                                    <div className="row">
                                        <form className='gapform' onSubmit={handleSubmit}>
                                            <div class="form-row firstgroup">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label htmlFor="inputState">You Are?</label>
                                            ...
                                            <div class="form-row firstgroup">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="medicalid" placeholder="Medical ID" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label htmlFor="orderproduct">Product to Order</label>
                                                    <input type="text" class="form-control" id="orderproduct" placeholder="Product to Order" />
                                                </div>
                                            </div>
                                            ...
                                            <button type="submit" class="btn btn-warning w-25 buttton" onClick={enableMetamask}>Place Order</button>
                                        </form>
                                        {/* Success message */}
                                    {isSuccess && (
...
export default OrderTabsWarehouses